...
export const Post = ({post, index, indexVisable = true}) => {

  const shortText = post.text.slice(0, 160) + (post.text.length > 160 ? '...' : '')
      ...
      <Link className={styles.link} to={'/post/' + post.id}>
        <div className={styles.postWrapper}>
          <div className={styles.post}>
            {indexVisable && <h3 className={styles.index}>{index + 1}</h3>}
          ...
          <div className={styles.editElements}>
            ...
            <div className={styles.changePost}>
              <svg fill="#000000" width="40px" height="40px" viewBox="-5 0 32 32" version="1.1"
